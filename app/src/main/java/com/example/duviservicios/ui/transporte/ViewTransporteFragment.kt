...
class ViewTransporteFragment : Fragment(),ILoadOrderCallbackListener {

    private var viewOrderModel : ViewTransporteModel?=null
    ...
    override fun onCreateView(
        ...
        viewOrderModel = ViewModelProviders.of(this).get(ViewTransporteModel::class.java!!)
