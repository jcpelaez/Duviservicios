...
import com.example.duviservicios.EventBus.FootItemClick
...
class MyFoodListaAdapter (internal var context: Context,
    ...
    init {
       compositeDisposable = CompositeDisposable()
        ...
        override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
            ...
            holder.setListener(object : IRecyclerItemClickListener {
                override fun onItemClick(view: View, pos: Int) {
                    Commun.foodSelected = foodList.get(pos)
                    Commun.foodSelected!!.key = pos.toString()
                    EventBus.getDefault().postSticky(FootItemClick(true, foodList.get(pos)))
                }
            })
        ...
        override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int
        ): MyFoodListaAdapter.MyViewHolder {
